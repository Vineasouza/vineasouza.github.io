      ...
      <div className="rightContainerInitial">
          ...
          {menuIcon && (
            <Zoom>
              <div className="navBarIconContainer">
                <a className="textNavBarIcon" href="#home">
                  Home
                </a>
                <a className="textNavBarIcon" href="#sobremim">
                  Sobre Mim
                </a>
                <a className="textNavBarIcon" href="#portifolio">
                  Portifólio
                </a>
                <a className="textNavBarIcon" href="#contato">
                  Contato
                </a>
              </div>
            </Zoom>
        ...
        <Fade top>
          <div className="navBar">
            <a className="textNavBar" href="#home">
              Home
            </a>
            <a className="textNavBar" href="#sobremim">
              Sobre Mim
            </a>
            <a className="textNavBar" href="#portifolio">
              Portifólio
            </a>
            <a className="textNavBar" href="#contato">
              Contato
            </a>
          </div>
        </Fade>
